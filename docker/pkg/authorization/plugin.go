package authorization // import "github.com/ory/dockertest/docker/pkg/authorization"

import (
	"sync"

	"github.com/ory/dockertest/docker/pkg/plugingetter"
	"github.com/ory/dockertest/docker/pkg/plugins"
)
